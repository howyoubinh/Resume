...
\textit{Systems Engineer 1} \hfill August 2019 --- May 2020\\
\vspace{-2mm}
\begin{itemize} \itemsep 0.05pt
	\item Built, trained, and tested an RNN-LSTM model on multiple datasets consisting of 200K+ datapoints for detecting disturbances and noise in ECG localization
	\item Identified key respiratory signal templates in Matlab to determine range of differences and predicting disturbance
	\item Developed pacing detection to blank signal and restore correct position and orientation of catheter using ultrasound signals
