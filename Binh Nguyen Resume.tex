...
\begin{itemize} \itemsep 0.05pt
	...
	\item Developed a real-time QRS detection method for optimizing virtual positional reference in software system
	\item Generated respiration cycle templates for categorizing different types of cardiac arrhythmia
	\item Coordinated with cross-functional teams to execute verification and validation testing for R\&D
\end{itemize}
...
%==== Interests ====%
\header{Interests}
Medical devices, Signal processing, HCI, Electrophysiology, Virtual reality, 3D Modeling, Music, Cooking, Fitness
\end{document}